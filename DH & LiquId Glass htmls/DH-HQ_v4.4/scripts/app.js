...
function showLegend(){ try{ document.getElementById('legend-section')?.classList.remove('hidden'); }catch(e){} }
    ...
    hideLegend();
        ...
        document.querySelectorAll('.primary-switcher, .secondary-switcher, #positional-filters, #leagueSelect, .control-button').forEach(el => {
        ...
        <div class="trade-container glass-panel">
          <div class="trade-header">
            ...
            <div class="trade-header-center">
              <button id="collapseTradeButton"><i class="fa-solid fa-square-caret-down"></i></button>
            </div>
